...
if use_input:
    ...
    if action_choice == "1":
        print('''
Note:-
1. If your Target device is windows
run this script in windows because its
autogenerated executable file based on
the system which running this script
2. Icon optional (.ico{ for win }/.png{ for linux })
''')
